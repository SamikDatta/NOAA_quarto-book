...
This is a template for [a simple Quarto book](https://samikdatta.github.io/NOAA_quarto-book/) (`type: book`). It has download links (under the logo) for PDF or docx download.
